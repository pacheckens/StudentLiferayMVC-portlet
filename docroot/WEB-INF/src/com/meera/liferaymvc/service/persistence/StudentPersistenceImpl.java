...
import com.meera.liferaymvc.NoSuchStudentException;
import com.meera.liferaymvc.model.Student;
import com.meera.liferaymvc.model.impl.StudentImpl;
import com.meera.liferaymvc.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	...
	@Override
	public Student updateImpl(com.meera.liferaymvc.model.Student student)
		throws SystemException {
		student = toUnwrappedModel(student);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.meera.liferaymvc.model.Student")));
