...
public class StudentWrapper implements Student, ModelWrapper<Student> {
	...
	*/
	...
	@Override
	public int compareTo(com.meera.liferaymvc.model.Student student) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.meera.liferaymvc.model.Student> toCacheModel() {
		return _student.toCacheModel();
	}

	@Override
	public com.meera.liferaymvc.model.Student toEscapedModel() {
		return new StudentWrapper(_student.toEscapedModel());
	}

	@Override
	public com.meera.liferaymvc.model.Student toUnescapedModel() {
